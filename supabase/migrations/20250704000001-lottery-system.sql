...
CREATE INDEX idx_lottery_tickets_lottery_event ON public.lottery_tickets(lottery_event_id);
CREATE INDEX idx_lottery_tickets_user ON public.lottery_tickets(user_id);
CREATE INDEX idx_lottery_tickets_rank ON public.lottery_tickets(rank_position);
CREATE INDEX idx_lottery_prizes_lottery_event ON public.lottery_prizes(lottery_event_id);

-- Insert current lottery event
INSERT INTO public.lottery_events (title, description, start_date, end_date, status) VALUES
('Gift Lottery', 'From July 5 to July 25, participate in the gift lottery. Collect the most lottery tickets and win valuable prizes!', '2025-07-05 00:00:00+00', '2025-07-25 23:59:59+00', 'active');
